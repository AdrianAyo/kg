...
define("__TO__", "ayo71@wp.pl");

//Success message
define('__SUCCESS_MESSAGE__', "Twoja wiadomość została wysłana. Odezwę się do Ciebie wkrótce!");

//Error message 
define('__ERROR_MESSAGE__', "Wiadomośc nie została wysłana. Spróbuj ponownie!");

//Messege when one or more fields are empty
define('__MESSAGE_EMPTY_FIELDS__', "Wypełnij wszystkie pola!");
